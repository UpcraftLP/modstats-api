...
namespace ModStats.API.Migrations
{
    ...
    [Migration("20230812173602_HistSupportedVersions")]
    partial class HistSupportedVersions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModStats.API.Models.Histograms.SupportedVersionsSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("hist_supported_versions");
                });
            ...
            modelBuilder.Entity("ModStats.API.Models.Minecraft.McVersion", b =>
                {
                    ...
                    b.Property<Guid?>("SupportedVersionsSnapshotId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SupportedVersionsSnapshotId");
            ...
            modelBuilder.Entity("ModStats.API.Models.Mods.Loaders.ModLoader", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(5017),
                            Name = "Forge",
                            Slug = "forge"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(5064),
                            Name = "Fabric",
                            Slug = "fabric"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(5069),
                            Name = "Quilt",
                            Slug = "quilt"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(5091),
                            Name = "NeoForge",
                            Slug = "neoforge"
                        });
                });
            ...
            modelBuilder.Entity("ModStats.API.Models.Platforms.Platform", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(6520),
                            Name = "CurseForge",
                            Slug = "curseforge"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 8, 12, 17, 36, 1, 859, DateTimeKind.Utc).AddTicks(6535),
                            Name = "Modrinth",
                            Slug = "modrinth"
                        });
                });
            ...
            modelBuilder.Entity("ModStats.API.Models.Histograms.SupportedVersionsSnapshot", b =>
                {
                    b.HasOne("ModStats.API.Models.Mods.Mod", "Mod")
                        .WithMany("HistoricalSupportedVersionsData")
                        .HasForeignKey("ModId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ModStats.API.Models.Minecraft.McVersion", b =>
                {
                    ...
                    b.HasOne("ModStats.API.Models.Histograms.SupportedVersionsSnapshot", null)
                        .WithMany("Data")
                        .HasForeignKey("SupportedVersionsSnapshotId");
                });
            ...
            modelBuilder.Entity("ModStats.API.Models.Mods.Mod", b =>
                {
                    ...
                    b.Navigation("HistoricalSupportedVersionsData");
